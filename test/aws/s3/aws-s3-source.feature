Feature: AWS S3 - Source
  ...
  Scenario: Verify AWS-S3 Kamelet to log binding
    ...
    # Create binding
    When load Pipe aws-s3-source-pipe.yaml
    And Pipe aws-s3-source-pipe is available
    And Camel K integration aws-s3-source-pipe is running
    Then Camel K integration aws-s3-source-pipe should print Installed features
    ...
    Then Camel K integration aws-s3-source-pipe should print ${aws.s3.message}
